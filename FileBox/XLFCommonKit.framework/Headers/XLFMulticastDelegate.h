...
@class XLFMulticastDelegateEnumerator;
...
@interface XLFMulticastDelegate : NSObject
...
- (XLFMulticastDelegateEnumerator *)delegateEnumerator;

@end


@interface XLFMulticastDelegateEnumerator : NSObject
