...
typedef NS_ENUM(NSUInteger, XLFPageControlAlignment) {
	XLFPageControlAlignmentLeft = 1,
	XLFPageControlAlignmentCenter,
	XLFPageControlAlignmentRight
};

typedef NS_ENUM(NSUInteger, XLFPageControlVerticalAlignment) {
	XLFPageControlVerticalAlignmentTop = 1,
	XLFPageControlVerticalAlignmentMiddle,
	XLFPageControlVerticalAlignmentBottom
};

@interface XLFPageControl : UIControl
...
@property (nonatomic) CGFloat selectedIndicatorDiameter                 UI_APPEARANCE_SELECTOR; // deafult is 6
@property (nonatomic) XLFPageControlAlignment alignment					UI_APPEARANCE_SELECTOR; // deafult is Center
@property (nonatomic) XLFPageControlVerticalAlignment verticalAlignment	UI_APPEARANCE_SELECTOR;	// deafult is Middle
